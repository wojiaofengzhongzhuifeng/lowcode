...
const productPath = `/gate-lowcode-component-1@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('gate-lowcode-component-1', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'gate-lowcode-component-1': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
