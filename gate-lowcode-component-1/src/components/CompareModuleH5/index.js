...
function CompareModuleH5({compareData}) {
  return (
      <div className='compare-module-h5-wrapper'>
        <div className='compare-module-h5-container'>
          <div className='compare-a-h5'>
            <div className='compare-module-card-wrapper-h5'>
              <div className='compare-module-card-header-h5'>
                <h3 className='compare-module-card-header-title-h5 compare-module-card-header-title-Left-h5'>
                  {compareData?.a?.title}
                </h3>
              </div>
                          ...
                          {col?.map((item,idx)=>{
                            return (
                                <li className='compare-module-item' key={Math.random()+idx}>
                                  ...
                                  <div className='compare-module-item-contexts'>
                                    {item?.context}
                                  </div>
                                </li>
                            )
          ...
          <div className='compare-b-h5'>
            <div className='compare-module-card-wrapper-h5'>
              <div className='compare-module-card-header-h5'>
                <h3 className='compare-module-card-header-title-h5'>
                  {compareData?.b?.title}
                </h3>
              </div>
...
export default CompareModuleH5